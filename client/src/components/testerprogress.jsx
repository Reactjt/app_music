...
const [myID, setMyID] = useState(null);
 ...
 console.log("Container element:", waveformContainerRef.current.id); 
  ...
  console.log("Container element:", document.getElementById("#waveform-container"));
      ...
      <div className="flex-grow overflow-hidden">
        ...
        {currentSong ? (
          <div className="w-full h-1/10 py-8 sm:py-5 justify-center align-middle   bg-zinc-900  text-white flex items-center px-4 fixed bottom-0">
            ...
            {/* progress bar */}
             <div ref={waveformContainerRef} id={waveformid} className="w-1/2 mb-8" 
             onLoad={(e) => {
              setMyID(e.currentTarget.getAnimations("id"));
               setIsLoaded(true) }}
             ></div>
